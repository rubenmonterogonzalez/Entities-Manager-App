    ...
    <div class="block m-auto px-6 pb-6 pt-3 rounded-sm shadow-lg bg-white max-w-md">
      <form @submit.prevent="handleSubmit" class="min-w-[300px]">
        <div class=" my-4 text-center">
          <h2 class="font-bold text-xl max-w-[240px] m-auto leading-6 mb-2">Let's continue adding some fields
          </h2>
          <p class="text-gray-500 text-sm">This is the STEP 2 into the process</p>
        </div>
        <div class="grid grid-cols-2 mb-6">
          <label for="">Coordinates GPS
